...
${MONGO_SHELL} --nodb --quiet --eval "${EVAL}${VERBOSE}${VERBOSE_LEN}" ${CONFIG} ${MOMONGER_ROOT}/lib/utils.js ${CURDIR}/../tokenize/lib/dictionary.js ${CURDIR}/lib/view_df.js | grep -v '^loading file:'
